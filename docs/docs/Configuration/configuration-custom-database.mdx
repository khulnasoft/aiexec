...
For an example, see the [`docker-compose.yml`](https://gitlab.com/khulnasoft/aiexec/blob/main/docker_example/docker-compose.yml) file in the Aiexec repository.
