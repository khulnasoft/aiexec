...
You might use these endpoints when developing custom Aiexec components for your own use or to share with the Aiexec community:
...
The following endpoints are for managing Aiexec MCP servers, both Aiexec-hosted MCP servers and external MCP server connections:
