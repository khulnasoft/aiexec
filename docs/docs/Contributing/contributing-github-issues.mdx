...
The [Issues page in the Aiexec repository](https://gitlab.com/khulnasoft/aiexec/issues) is actively updated with bugs and feature requests.
...
Use the [Aiexec repository's labels](https://gitlab.com/khulnasoft/aiexec/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or Aiexec in general, you can visit the [Aiexec GitHub Discussions page](https://gitlab.com/khulnasoft/aiexec/discussions) or reach out through other [Aiexec community](/contributing-community) channels.
