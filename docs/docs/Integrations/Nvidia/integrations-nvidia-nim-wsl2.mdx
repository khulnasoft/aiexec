...
In this example, you connect a Language Model component in Aiexec to a deployed `mistral-nemo-12b-instruct` NIM on an **RTX Windows system** with **WSL2**.
...
To connect the deployed NIM to Aiexec, add the **NVIDIA** language model component to a flow:
