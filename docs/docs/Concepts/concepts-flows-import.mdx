...
For an example Aiexec JSON file, examine the [Basic Prompting.json](https://gitlab.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/initial_setup/starter_projects/Basic%20Prompting.json) file in the Aiexec repository.
