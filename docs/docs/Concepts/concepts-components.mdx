...
For example, the [**Recursive Character Text Splitter** component](https://gitlab.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/components/langchain_utilities/recursive_character.py) is a child of the [`LCTextSplitterComponent`](https://gitlab.com/khulnasoft/aiexec/blob/main/src/backend/base/aiexec/base/textsplitters/model.py) class.
